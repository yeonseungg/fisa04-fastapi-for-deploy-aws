# AWS를 사용한 FastAPI 서버 클라우드 마이그레이션

이 실습 자료는 FastAPI 기반의 애플리케이션을 AWS 환경에 배포하기 위한 마이그레이션 과정을 다룹니다. Docker를 사용하여 이미지화하고, .env 파일을 통해 환경 변수 관리를 하며, EC2 인스턴스 상에서 실행할 수 있도록 구성합니다.
